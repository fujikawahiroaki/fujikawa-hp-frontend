...
(() => {
  ...
  class AV extends _E{constructor(){super();this.length = 0}};class AW extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class EG extends _E{constructor(){super();this.length = 0}};class EI extends _E{constructor(){super();this.length = 0}};class EH extends _E{constructor(){super();this.length = 0}};class EF extends _E{constructor(){super();this.length = 0}};class EK extends _E{constructor(){super();this.length = 0}};class EL extends _E{constructor(){super();this.length = 0}};class EN extends _E{constructor(){super();this.length = 0}};class EM extends _E{constructor(){super();this.length = 0}};class EC extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class EB extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class EY extends _E{constructor(){super();this.length = 0}};class EV extends _E{constructor(){super();this.length = 0}};class EW extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class EX extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class BL extends _E{constructor(){super();this.length = 0}};class BN extends _E{constructor(){super();this.length = 0}};class BP extends _E{constructor(){super();this.length = 0}};class BR extends _E{constructor(){super();this.length = 0}};class BT extends _E{constructor(){super();this.length = 0}};class BV extends _E{constructor(){super();this.length = 0}};class BW extends _E{constructor(){super();this.length = 0}};class CP extends _E{constructor(){super();this.length = 0}};class CW extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class CX extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class CG extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class CQ extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class DV extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class CA extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class DU extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class DT extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class BZ extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class DB extends _E{constructor(){super();this.length = 0}};class CT extends _E{constructor(){super();this.length = 0}};class DC extends _E{constructor(){super();this.length = 0}};class DD extends _E{constructor(){super();this.length = 0}};class DE extends _E{constructor(){super();this.length = 0}};class DF extends _E{constructor(){super();this.length = 0}};class DH extends _E{constructor(){super();this.length = 0}};class DG extends _E{constructor(){super();this.length = 0}};class DI extends _E{constructor(){super();this.length = 0}};class DK extends _E{constructor(){super();this.length = 0}};class DJ extends _E{constructor(){super();this.length = 0}};class DL extends _E{constructor(){super();this.length = 0}};class FA extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class FB extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class CF extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class EU extends _E{constructor(_0){super();this._0 = _0;this.length = 1}};class CB extends _E{constructor(){super();this.length = 0}};const F = _R({hostname:["hostname",Decoder.string],protocol:["protocol",Decoder.string],origin:["origin",Decoder.string],search:["search",Decoder.string],path:["path",Decoder.string],hash:["hash",Decoder.string],host:["host",Decoder.string],port:["port",Decoder.string]});const G = _R({key:["key",Decoder.string],value:["value",Decoder.string]});const H = _R({});const I = _R({status:["status",Decoder.number],body:["body",Decoder.string]});const J = _R({});const K = _R({});const L = _R({});const M = _R({});const N = _R({});const O = _R({});const P = _R({});const Q = _R({});const R = _R({});const S = _R({});const T = _R({});const U = _R({});const V = _R({});const W = _R({});const X = _R({});const Y = _R({});const Z = _R({});const AA = _R({});const AB = _R({});const AC = _R({height:["height",Decoder.number],bottom:["bottom",Decoder.number],width:["width",Decoder.number],right:["right",Decoder.number],left:["left",Decoder.number],top:["top",Decoder.number],x:["x",Decoder.number],y:["y",Decoder.number]});const AD = _R({});const AE = _R({caseInsensitive:["caseInsensitive",Decoder.boolean],multiline:["multiline",Decoder.boolean],unicode:["unicode",Decoder.boolean],global:["global",Decoder.boolean],sticky:["sticky",Decoder.boolean]});const AF = _R({submatches:["submatches",Decoder.array(Decoder.string),Encoder.array()],match:["match",Decoder.string],index:["index",Decoder.number]});const AG = _R({});const AH = _R({});const AI = _R({id:["id",Decoder.string],name:["name",Decoder.string],summary:["summary",Decoder.string],publishedYear:["publishedYear",Decoder.number],publishedMonth:["publishedMonth",Decoder.number],publishedDay:["publishedDay",Decoder.number]});const AJ = _R({results:["results",Decoder.array(((_)=>AI.decode(_))),Encoder.array(((_)=>AI.encode(_)))]});const AK = _R({});const AL = _R({sortKey:["sortKey",Decoder.string],sortable:["sortable",Decoder.boolean],label:["label",Decoder.string],shrink:["shrink",Decoder.boolean]});const AM = _R({originalHeight:["originalHeight",Decoder.number],originalWidth:["originalWidth",Decoder.number],currentHeight:["currentHeight",Decoder.number],currentWidth:["currentWidth",Decoder.number],left:["left",Decoder.number],top:["top",Decoder.number]});const AN = _R({titleWoff2:["titleWoff2",Decoder.string],titleWoff:["titleWoff",Decoder.string],titleName:["titleName",Decoder.string],regularWoff2:["regularWoff2",Decoder.string],regularWoff:["regularWoff",Decoder.string],boldWoff2:["boldWoff2",Decoder.string],boldWoff:["boldWoff",Decoder.string],name:["name",Decoder.string]});const AO = _R({source:["source",Decoder.string],height:["height",Decoder.number],width:["width",Decoder.number],x:["x",Decoder.number],y:["y",Decoder.number]});const AP = _R({});const AQ = _R({color:["color",Decoder.string],text:["text",Decoder.string]});const AR = _R({s900:["s900",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s800:["s800",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s700:["s700",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s600:["s600",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s500:["s500",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s400:["s400",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s300:["s300",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s200:["s200",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s100:["s100",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],s50:["s50",((_)=>AQ.decode(_)),((_)=>AQ.encode(_))],saturation:["saturation",Decoder.number],lightness:["lightness",Decoder.number],hue:["hue",Decoder.number]});const AY=new(class extends _M{gp(qi){return (document.createElement(qi))}gb(qj){return ((() => {
      ...
      return foundElements
        ...
        left: qy,
        top: qz
      }))}});const EA=new(class extends _M{ra(rb){return ((() => {
      if (!this._a) {
    ...
    })())}});const AU=new(class extends _M{g(re,rc){return (()=>{let rd = rc;if(rd instanceof AW){const rf = rd._0;return new AW(re(rf))} else if(rd instanceof AV){return new AV()}})()}gd(ri,rg){return (()=>{let rh = rg;if(rh instanceof AV){return ri} else if(rh instanceof AW){const rj = rh._0;return rj}})()}rk(ro,rl){return (()=>{let rm = rl;if(rm instanceof AW){const rn = rm._0;return new EB(rn)} else if(rm instanceof AV){return new EC(ro)}})()}});const DO=new(class extends _M{is(rq,rp){return (new Promise((resolve) => {
    	setTimeout(() => {
        resolve(rp)
      }, rq)
    ...
    }))}});const ED=new(class extends _M{rs(){return new H({withCredentials:false,method:`GET`,body:(null),headers:[],url:``})}rt(rv){return ((..._) => ED.ru(rv, ..._))(((..._) => ED.rw(`GET`, ..._))(ED.rs()))}rw(ry,rx){return _u(rx, {method:ry})}ru(sa,rz){return _u(rz, {url:sa})}sb(se){return ED.sc(EE.sd(), se)}sc(sf,sg){return (new Promise((resolve, reject) => {
      ...
      try {
        ...
        reject(new J({type:new EF(),status:(xhr.status),url:sg.url}))
      }
      ...
      xhr.addEventListener('error', (event) => {
        ...
        reject(new J({type:new EG(),status:(xhr.status),url:sg.url}))
      })

      xhr.addEventListener('timeout', (event) => {
        delete this._requests[sf]

        reject(new J({type:new EH(),status:(xhr.status),url:sg.url}))
      })
      ...
      xhr.addEventListener('abort', (event) => {
        ...
        reject(new J({type:new EI(),status:(xhr.status),url:sg.url}))
      })

      xhr.send(sg.body)
    }))}});const AS=new(class extends _M{b(){return EA.ra(AS.sh())}sh(){return (window.location.href)}si(){return (window.innerWidth)}sj(){return (window.innerHeight)}es(sl){return (()=>{let sk = AS.b();let sm = EA.ra(sl);return (_compare(sk.hostname, sm.hostname) && _compare(sk.protocol, sm.protocol) && _compare(sk.origin, sm.origin) && _compare(sk.path, sm.path) && _compare(sk.host, sm.host) && _compare(sk.port, sm.port))})()}sn(so,sp){return ((() => {
    ...
    })())}});const DY=new(class extends _M{ne(){return ([])}mo(sw,sv){return ((() => {
      for (let item of sv) {
        if (_compare(item, sw)) {
          return true
        }
      ...
      return newSet
    })())}});const EJ=new(class extends _M{tb(tc,td,te){return ((() => {
      try {
        tc.setItem(td, te)
        return new EB(null)
      } catch (error) {
        switch(error.name) {
          case 'SecurityError':
            return new EC(new EK())
          case 'QUOTA_EXCEEDED_ERR':
            return new EC(new EL())
          case 'QuotaExceededError':
            return new EC(new EL())
          case 'NS_ERROR_DOM_QUOTA_REACHED':
            return new EC(new EL())
          default:
            return new EC(new EM())
        }
      }
    })())}tf(tg,th){return ((() => {
      try {
    ...
    })())}});const EO=new(class extends _M{ti(tj,tk){return EJ.tb((localStorage), tj, tk)}tl(tm){return EJ.tf((localStorage), tm)}});const AT=new(class extends _M{py(tn){return ((() => {
      let first = tn[0]
      if (first !== undefined) {
        return new AW((first))
      } else {
      ...
      return -1
    })())}});const EP=new(class extends _M{us(ut){return ((() => {
      try {
        return new AW((JSON.parse(ut)))
      } catch (error) {
        return new AV()
      }
    })())}});const CR=new(class extends _M{hf(uu){return _compare(uu, ``)}uv(ux){return _compare(CR.uw(ux), ``)}gz(uy){return !CR.uv(uy)}fg(va,uz){return (uz.join(va))}uw(vb){return (vb.trim())}dr(vc){return (vc
      .replace(/[^\p{Lu}\p{Ll}0-9\-_]+/gu, '-') // Replace non alphanumerical with dashes
      .replace(/\p{Lu}([\p{Ll}0-9]+|[\p{Lu}0-9]+)?/gu, '-$&')
      .replace(/-{2,}/g, '-')
      .replace(/^-+/i, '')
      .replace(/-+$/i, '')
      .toLowerCase())}});const EE=new(class extends _M{sd(){return (([1e7] + -1e3 + -4e3 + -8e3 + -1e11)
      .replace(/[018]/g, c =>
        (c ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> c / 4)
          .toString(16)))}});const CM=new(class extends _M{gq(){return (false)}df(vd){return (!!vd)}mj(ve){return ((() => {
      if (ve == null || typeof ve == 'boolean') {
        return []
      } else if (Array.isArray(ve)) {
        return ve.reduce((memo, child) => {
          return memo.concat(CM.mj((child)))
        }, [])
      } else {
        return [ve]
      }
    })())}});const EQ=new(class extends _M{vf(){return new AC({bottom:0,height:0,width:0,right:0,left:0,top:0,x:0,y:0})}});const BD=new(class extends _M{as(vg){return (requestAnimationFrame(vg))}at(vh){return (cancelAnimationFrame(vh) || -1)}});const ER=new(class extends _M{vi(vj){return ((() => {
      if (window.DEBUG) {
        window.DEBUG.log(vj)
      } else {
        console.log(vj)
      ...
      return new AV()
    })())}du(wf,we,wg){return ((..._) => AU.gd(we, ..._))(CK.wb(wf, wg))}});const ET=new(class extends _M{vr(wk,wh){return (()=>{let wi = wh;if(wi instanceof EB){const wj = wi._0;return wj} else if(wi instanceof EC){return wk}})()}});const AZ=new(class extends _M{t(){return AZ.wl(null)}hd(wm){return AZ.wl(null)}wl(wn){return (Promise.resolve(wn))}ja(){return ((() => {
      let resolve, reject;
    ...
    })())}});const DM=new(class extends _M{gk(wo){return (()=>{let wp = wo;if(wp instanceof DB){return new DD()} else if(wp instanceof CT){return new DE()} else if(wp instanceof DC){return new DF()} else if(wp instanceof DD){return new DB()} else if(wp instanceof DE){return new CT()} else if(wp instanceof DF){return new DC()} else if(wp instanceof DH){return new DK()} else if(wp instanceof DG){return new DJ()} else if(wp instanceof DI){return new DL()} else if(wp instanceof DK){return new DH()} else if(wp instanceof DJ){return new DG()} else if(wp instanceof DL){return new DI()}})()}});const CL=new(class extends _M{cr(wq){return (()=>{let wr = wq;if(wr instanceof CF){const ws = wr._0;return `${ws}em`} else if(wr instanceof EU){const wt = wr._0;return `${wt}px`} else if(wr instanceof CB){return `inherit`}})()}});const CI=new(class extends _M{constructor(){super();this._d({ev:(()=>{return $r()}),cb:(()=>{return $s()}),cc:(()=>{return $t()}),cd:(()=>{return $u()}),ce:(()=>{return $v()}),cf:(()=>{return $w()}),cg:(()=>{return $x()}),mz:(()=>{return $y()})})}});const AX=new(class extends _P{constructor(){super();this.state={i:new AV()}}get i(){return this.state.i;}a(e){return (()=>{let c = AS.b();return (()=>{const _0 = [];const _1 = this._subscriptions;let _i = 0;for(let d of _1){_0.push(d.changes(c));_i++};return _0})()})()}update(){return (AT.f(this._subscriptions) ? (()=>{AU.g(((h)=>{return h()}), this.i);return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({i:new AV()})), _resolve)
...
if (!_2) { continue };_0.push((()=>{BB.af(y);BB.ag(y);return ah.action()})());_i++};return _0})());_i++};return _0})()})()}update(){return (AT.f(this._subscriptions) ? (()=>{AU.g(((al)=>{return al()}), this.am);return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({am:new AV()})), _resolve)
...
}))})()}});_program.addRoutes([{handler:((yk)=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await BI.xc(new BL())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[Decoder.string],mapping:['page'],path:`/?page=:page`},{handler:(()=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await BI.xc(new BL())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[],mapping:[],path:`/`},{handler:(()=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await BI.xc(new BN())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[],mapping:[],path:`/about`},{handler:(()=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await BI.xc(new BP())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[],mapping:[],path:`/works`},{handler:(()=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await BI.xc(new BR())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[],mapping:[],path:`/computer`},{handler:(()=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await EZ.wu()})(),(async()=>{await BI.xc(new BT())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[],mapping:[],path:`/papers`},{handler:(()=>{(async()=>{let _ = null;try{await Promise.all([(async()=>{await BI.xc(new BV())})()])}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in parallel expression:`);console.warn(_error)}};return _})()}),decoders:[],mapping:[],path:`/specimens`},{handler:(()=>{BI.xc(new BW())}),decoders:[],mapping:[],path:`*`}]);class BH extends _C{constructor(props){super(props);this._d({bi:["children",[]]})}render(){return (_createPortal(this.bi, document.body))}};;class E extends _C{get bj(){return BI.bl;}componentWillUnmount(){BI._unsubscribe(this)}componentDidMount(){BI._subscribe(this)}render(){return (()=>{let bk = this.bj;if(bk instanceof BL){return $a()} else if(bk instanceof BN){return $c()} else if(bk instanceof BP){return $e()} else if(bk instanceof BR){return $g()} else if(bk instanceof BT){return $i()} else if(bk instanceof BV){return $k()} else if(bk instanceof BW){return $m()}})()}};;class BK extends _C{render(){return _h("div", {}, [_h("h2", {}, [`ようこそ`]),$n()])}};;class BM extends _C{render(){return _h("div", {}, [_h("h2", {}, [`自己紹介`]),_h(BX, {bm:`藤川浩明`}, _array(_h("img", {"src":`/assets/fujikawa_400x400_5f5c6c3f25766e56479c94cad00695c5.jpg`,className:`a`}), _h("p", {}, [`生年: 1994年`]), _h("p", {}, [`出身: 山口県`]), _h("p", {}, [`居住地: 沖縄県本部町`]), _h("p", {}, [`好きな虫: ゴミムシダマシや旧ホソカタムシなどの枯れ木につく甲虫全般、旧タテヅノマルバネクワガタ`])))])}};;class BU extends _C{render(){return _h("div", {}, [_h("h2", {}, [`所蔵標本検索`]),_h("h3", {}, [`現在準備中です`])])}};;class BO extends _C{render(){return _h("div", {}, [_h("h2", {}, [`沖丸環境調査`]),$o(),$p()])}};;class BS extends _C{render(){return _h("div", {}, [_h("h2", {}, [`報文・短報など`]),_h(BX, {bm:``}, _array(_h("p", {}, [`※各報の説明に含まれる学名・和名は出版当時のものです。現在は変更されている可能性があることにご注意ください。`]), _h(BY, {bn:[[`田之岡綾花・藤川浩明, 2022. 沖縄県本部町におけるアサギマダラマーキング報告. 琉球の昆虫, (46): 78.`, [new BZ(_h("div", {}, [`アサギマダラ`,_h("i", {}, [`Parantica`]),_h("i", {}, [` sita`]),` (Kollar, [1844])`,` の沖縄県本部町における2021年のマーキング調査報告です。`])), new CA(new Record({items:[_h("div", {})],breakOnMobile:false}))]], [`青井光太郎・福田悠人・藤川浩明・伊藤直哉, 2022. 南西諸島におけるハイイロテントウの分布. さやばねニューシリーズ, (45): 37-39.`, [new BZ(_h("div", {}, [`ハイイロテントウ`,_h("i", {}, [`Olla`]),_h("i", {}, [` v-nigrum`]),` (Mulsant, 1866)`,` の南西諸島における分布をまとめました。本種の奄美大島、徳之島、沖永良部島、伊平屋島、伊江島、平安座島、津堅島、藪地島、西表島における初記録は本報となります。また本種の分布や生態についての若干の考察も含まれています。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`http://kochugakkai.sakura.ne.jp/publication/sayabane/SayabaneNS(45).html`}, [`日本甲虫学会HP`])]), _h("div", {}, [_h("a", {"href":`https://jglobal.jst.go.jp/detail?JGLOBAL_ID=202202227782159723&rel=1#%7B%22category%22%3A%220%22%2C%22keyword%22%3A%22%5C%22202250000788509100%5C%22%22%7D`}, [`J-GLOBAL`])])],breakOnMobile:false}))]], [`藤川浩明・緒方裕大, 2022. 西表島および石垣島におけるフチグロチビオオキノコの記録. さやばねニューシリーズ, (45): 34.`, [new BZ(_h("div", {}, [`フチグロチビオオキノコ`,_h("i", {}, [`Tritoma `]),`(`,_h("i", {}, [`Tritoma`]),`)`,_h("i", {}, [` andoi`]),` Narukawa, 2003`,` の西表島初記録および石垣島における原記載以来の追加記録です。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`http://kochugakkai.sakura.ne.jp/publication/sayabane/SayabaneNS(45).html`}, [`日本甲虫学会HP`])]), _h("div", {}, [_h("a", {"href":`https://jglobal.jst.go.jp/detail?JGLOBAL_ID=202202289858901406&rel=1#%7B%22category%22%3A%220%22%2C%22keyword%22%3A%22%5C%22202250000788509100%5C%22%22%7D`}, [`J-GLOBAL`])])],breakOnMobile:false}))]], [`藤川浩明・吉武啓, 2022. 奄美群島におけるアカツヤツツヒラタムシおよび先島諸島におけるクロツヤツツヒラタムシの新産地. さやばねニューシリーズ, (45): 2-3.`, [new BZ(_h("div", {}, [`アカツヤツツヒラタムシ`,_h("i", {}, [`Passandra`]),_h("i", {}, [` tenuicornis`]),` (Grouvelle, 1913)`,` の徳之島における初記録、および`,`クロツヤツツヒラタムシ`,_h("i", {}, [`Passandra`]),_h("i", {}, [` okinawana`]),` Aoki, 2008`,` の伊良部島と西表島における初記録です。`,`奄美大島におけるクロツヤツツヒラタムシの記録の問題点についても言及しています。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`http://kochugakkai.sakura.ne.jp/publication/sayabane/SayabaneNS(45).html`}, [`日本甲虫学会HP`])]), _h("div", {}, [_h("a", {"href":`https://jglobal.jst.go.jp/detail?JGLOBAL_ID=202202248049142810&rel=1#%7B%22category%22%3A%220%22%2C%22keyword%22%3A%22%5C%22202250000788509100%5C%22%22%7D`}, [`J-GLOBAL`])])],breakOnMobile:false}))]], [`藤川浩明, 2022. 沖縄島および渡嘉敷島におけるアシグロアオゴミムシの記録. さやばねニューシリーズ, (45): 1-2.`, [new BZ(_h("div", {}, [`アシグロアオゴミムシ`,_h("i", {}, [`Chlaenius`]),_h("i", {}, [` leucops`]),` (Waterhouse, 1823)`,` の沖縄島および渡嘉敷島における初記録です。本種の沖縄諸島における初記録となります。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`http://kochugakkai.sakura.ne.jp/publication/sayabane/SayabaneNS(45).html`}, [`日本甲虫学会HP`])]), _h("div", {}, [_h("a", {"href":`https://jglobal.jst.go.jp/detail?JGLOBAL_ID=202202224084769737`}, [`J-GLOBAL`])])],breakOnMobile:false}))]], [`小松拓実・藤川浩明, 2021. 沖縄島にてクロツツマグソコガネを採集. さやばねニューシリーズ, (44): 20-21.`, [new BZ(_h("div", {}, [`クロツツマグソコガネ`,_h("i", {}, [`Saprosites`]),_h("i", {}, [` japonicus`]),` Waterhouse, 1875`,` の沖縄島における追加記録です。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`http://kochugakkai.sakura.ne.jp/publication/sayabane/SayabaneNS(44).html`}, [`日本甲虫学会HP`])]), _h("div", {}, [_h("a", {"href":`https://jglobal.jst.go.jp/detail?JGLOBAL_ID=202202258926911915&rel=1#%7B%22category%22%3A%220%22%2C%22keyword%22%3A%22%5C%22202250000788509100%5C%22%22%7D`}, [`J-GLOBAL`])])],breakOnMobile:false}))]], [`藤川浩明・森井隆文, 2020. ヤンバルキモンヒメクチキムシ2例目の記録および♂の初記録. 月刊むし, (587): 46-47.`, [new BZ(_h("div", {}, [`ヤンバルキモンヒメクチキムシ`,_h("i", {}, [`Mycetochara `]),`(`,_h("i", {}, [`Ernocharis`]),`)`,_h("i", {}, [` nakanoi`]),` Akita & Masumoto, 2017 の2例目の記録および♂の初記録です。`,`発生時期、生息環境、同属多種との棲み分けについての断片的な知見と推測を述べていますが、調査不足のため確実性に欠けています。あくまで今後の調査を促進する叩き台となるための速報的な報告として受け取って頂きたいです。`])), new CA(new Record({items:[_h("div", {})],breakOnMobile:false}))]], [`藤川浩明・松村雅史, 2019. 沖縄島におけるウケンナミクチキムシの記録. 月刊むし, (583): 60-61.`, [new BZ(_h("div", {}, [`ウケンナミクチキムシ`,_h("i", {}, [`Upinella`]),_h("i", {}, [` ukenensis`]),` (Akita & Masumoto, 2012)`,` の沖縄島における初記録です。`])), new CA(new Record({items:[_h("div", {})],breakOnMobile:false}))]], [`藤川浩明・徳重典英, 2019. 沖縄島におけるクワガタツツキノコムシの記録. 月刊むし, (582): 60.`, [new BZ(_h("div", {}, [`クワガタツツキノコムシ`,_h("i", {}, [`Cis`]),_h("i", {}, [` capricornis`]),` Kawanabe, 1997`,` の沖縄島における初記録です。`])), new CA(new Record({items:[_h("div", {})],breakOnMobile:false}))]], [`中野文尊・藤川浩明・青井光太郎・緒方裕大, 2019. 採集例の極めて少ない琉球列島産メツブテントウ類3種の記録. 月刊むし, (582): 30-33.`, [new BZ(_h("div", {}, [`ナナホシメツブテントウ`,_h("i", {}, [`Nesolotis`]),_h("i", {}, [` amabilis`]),` (H. Kamiya, 1965)、`,`キイロメツブテントウ`,_h("i", {}, [`Nesolotis`]),_h("i", {}, [` azumai`]),` Sasaji, 1967、`,`クロメツブテントウ`,_h("i", {}, [`Nesolotis`]),_h("i", {}, [` impunctata`]),` Miyatake, 1966`,` を追加記録しました。このうちナナホシメツブテントウおよびキイロメツブテントウについては生態面・形態面ともにいくらかの新知見も含む内容となっています。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`https://cir.nii.ac.jp/crid/1521417753438325120`}, [`CiNii Research`])])],breakOnMobile:false}))]], [`藤川浩明・松村雅史・杉野廣一, 2019. ヘリアカデオキノコムシの沖縄島からの初記録. さやばねニューシリーズ, (34): 56-57.`, [new BZ(_h("div", {}, [`ヘリアカデオキノコムシ`,_h("i", {}, [`Scaphidium`]),_h("i", {}, [` reitteri`]),` Lewis, 1879 の沖縄島における初記録です。`,`本土産との形態的特徴の差異についても触れた上で、保科英人博士の見解に基づき亜種として位置づけるのは適切ではないと結論付けています。`])), new CA(new Record({items:[_h("div", {}, [_h("a", {"href":`http://kochugakkai.sakura.ne.jp/publication/sayabane/SayabaneNS(34).html`}, [`日本甲虫学会HP`])])],breakOnMobile:false}))]], [`藤川浩明, 2019. オキナワキモンヒメクチキムシの追加記録および発生時期について. 月刊むし, (580): 54.`, [new BZ(_h("div", {}, [`これまで原記載以降の正式な記録が無かったオキナワキモンヒメクチキムシ`,_h("i", {}, [`Mycetochara `]),`(`,_h("i", {}, [`Ernocharis`]),`)`,_h("i", {}, [` hiranoi`]),` Akita & Masumoto, 2014 の追加記録です。`,`本種の♂を初めて図示した報告となりますが、写真は白黒で交尾器の図も無いため、♂の形態の資料としては不十分です。`,`発生時期についての考察を含みますが、今思えば十分な調査と適切な考察をしたとは言い難い出来ですので、参考程度に留めて頂きたいです。`])), new CA(new Record({items:[_h("div", {}, [``])],breakOnMobile:false}))]], [`藤川浩明, 2018. 久米島におけるオキナワカタモンヒメクチキムシの記録. 月刊むし, (574): 12.`, [new BZ(_h("div", {}, [`これまで模式産地である沖縄島からのみ記録されていたオキナワカタモンヒメクチキムシ `,_h("i", {}, [`Mycetochara `]),`(`,_h("i", {}, [`Ernocharis`]),`)`,_h("i", {}, [` okinawaensis`]),` Akita & Masumoto, 2014 の久米島初記録です。`])), new CA(new Record({items:[_h("div", {}, [``])],breakOnMobile:false}))]], [`藤川浩明, 2016. ズバケデオネスイを西表島で採集. 月刊むし, (542): 43.`, [new BZ(_h("div", {}, [`ズバケデオネスイ `,_h("i", {}, [`Mimemodes caenifrons`]),` Grouvelle, 1913 `,`の西表島初記録です。`])), new CA(new Record({items:[_h("div", {}, [``])],breakOnMobile:false}))]]],bo:new CB(),bp:[`概要`, `関連リンク`]})))])}};;class BQ extends _C{render(){return _h("div", {}, [_h("h2", {}, [`計算機遊び`]),_h(BX, {bm:`もうひとつの趣味`}, _array(_h("p", {}, [`　昆虫採集に次ぐ第二の趣味として、プログラミングやLinux環境いじりなどのコンピュータ遊びを中学二年生の頃から細々と楽しんでいます。`,_h("br", {}),_h("ul", {}, [_h("li", {}, [`GitHub: `,_h("a", {"href":`https://github.com/fujikawahiroaki`,className:`b`}, [`fujikawahiroaki`])]),_h("li", {}, [`好きな言語: Crystal, Ruby`]),_h("li", {}, [`好きではないがよく使う言語: Python, JavaScript`]),_h("li", {}, [`ある程度使ったことのある言語: C, Common Lisp (SBCL), Emacs Lisp, Mint`]),_h("li", {}, [`好きなエディタ: 数年置きに変わりますが、今はVimが好きです`]),_h("li", {}, [`好きなOS: 数年置きに変わりますが、今はArch Linuxが好きです`])]),_h("p", {}, [`　最近は開発のみならず競技プログラミングも楽しむようになりました。正直なところ私は非常に弱く、平均的なプレイヤーよりかなり成長が遅いのですが、その高いゲーム性に魅せられて毎週のようにコンテストに参加しています。長期のヒューリスティックコンテストが特に好きです。`,_h("br", {}),`　AtCoderのアルゴは茶、ヒューリスティックは緑です。IDは`,_h("a", {"href":`https://atcoder.jp/users/fujikawahiroaki`,className:`b`}, [`fujikawahiroaki`])])]))),_h(BX, {bm:`開発したサービス・ソフトウェア`}, _array(_h("p", {}, [_h("strong", {}, [`WebSpecimanager`]),_h("br", {}),_h("a", {"href":`https://www.webspecimanager.net/`,className:`b`}, [`https://www.webspecimanager.net/`]),_h("br", {}),`昆虫標本のデータベース管理を支援するWebサービスです。`,_h("br", {}),`バックエンドはPythonとDjango REST Framework、フロントエンドはJavaScriptとReactで書きました。`]), _h("strong", {}, [`AtCoder Diet`]), _h("br", {}), _h("a", {"href":`https://atcoder-diet.fly.dev/`,className:`b`}, [`https://atcoder-diet.fly.dev/`]), _h("br", {}), `前日に解いたAtCoder問題の点数の合計で翌日の摂取可能カロリーを決定するジョークサイトです。`, _h("br", {}), `CrystalとKemalで書きました。簡素な静的サイトなのでフロントエンドはECRテンプレートエンジンで済ませています。`))])}};;class BJ extends _C{constructor(props){super(props);this._d({by:["children",[]]})}render(){return _h("div", {}, [_h(CC, {bx:_h("div", {className:`d`}, [_h(CD, {bq:1320,bv:_h(CE, {br:new CF(4.0),bs:`/`,bt:_h("div", {}, [$q()]),bu:`かれきむし`}),bw:[new CG(new Record({iconBefore:null,iconAfter:null,label:`ホーム`,target:``,href:`/`})), new CG(new Record({iconBefore:null,label:`沖丸環境調査`,iconAfter:null,target:``,href:`/works`})), new CG(new Record({iconBefore:null,label:`報文・短報`,iconAfter:null,target:``,href:`/papers`})), new CG(new Record({iconBefore:null,label:`所蔵標本`,iconAfter:null,target:``,href:`/specimens`})), new CG(new Record({iconBefore:null,label:`計算機遊び`,iconAfter:null,target:``,href:`/computer`})), new CG(new Record({iconBefore:null,label:`自己紹介`,iconAfter:null,target:``,href:`/about`}))]})]),bz:_h("div", {className:`c`}, [this.by]),ci:_h("div", {className:`c`}, [_h(CH, {ca:_h("div", {className:`e`}, [_h("p", {}, [`© 2023 藤川浩明`]),_h("p", {}, [`Powered by Mint Programming Language`])]),ch:[[``, [new CG(new Record({iconBefore:CI.cb,iconAfter:null,label:`ホーム`,target:``,href:`/`})), new CG(new Record({iconBefore:CI.cc,iconAfter:null,href:`/works`,label:`沖丸環境調査`,target:``})), new CG(new Record({iconBefore:CI.cd,iconAfter:null,href:`/papers`,label:`報文・短報`,target:``})), new CG(new Record({iconBefore:CI.ce,iconAfter:null,href:`/specimens`,label:`所蔵標本`,target:``})), new CG(new Record({iconBefore:CI.cf,iconAfter:null,href:`/computer`,label:`計算機遊び`,target:``})), new CG(new Record({iconBefore:CI.cg,iconAfter:null,href:`/about`,label:`自己紹介`,target:``}))]]]})])})])}};;class $A extends _C{constructor(props){super(props);this.state = new Record({cp:CK.cq()})}get cp(){return this.state.cp;}render(){return _h("div", {className:`f`}, [(()=>{const _0 = [];const _1 = this.cp;let _i = 0;for(let [co,cj] of _1){_0.push((()=>{const [ck,cl] = cj;return _h(CJ, {cm:cl,cn:ck,"key":co})})());_i++};return _0})()])}_persist(){A=this}};;let A;class CD extends _C{constructor(props){super(props);this._d({ct:[null,new CF(3.5)],cs:[null,new CB()],dm:[null,CI.ev],bw:[null,[]],et:[null,new CF(2)],bq:[null,1000],bv:[null,null]});this.state = new Record({dc:0,dv:CK.cq(),da:AS.b()})}$g(){const _={[`--a-a`]:CL.cr(this.cs),[`--a-b`]:CL.cr(this.ct)};return _}$h(cu){const _={};(cu ? Object.assign(_, {[`--b-a`]:`var(--primary-color)`}) : Object.assign(_, {[`--b-a`]:`inherit`}));return _}get cx(){return (this._base ? new AW(this._base) : new AV);}get dc(){return this.state.dc;}get dv(){return this.state.dv;}get da(){return this.state.da;}componentWillUnmount(){AX._unsubscribe(this);BG._unsubscribe(this)}componentDidUpdate(){if (true) {
  AX._subscribe(this, new L({changes:this.cv}))
} else {
  AX._unsubscribe(this)
};if (true) {
  BG._subscribe(this, new Z({changes:this.cw,element:this.cx}))
} else {
  ...
  BG._unsubscribe(this)
}}cy(){return B.cz(this.bw)}cv(db){return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({da:db})), _resolve)
}))}cw(dd){return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({dc:dd.width})), _resolve)
}))}de(dg,dj,di){return _h(React.Fragment, {}, [(CM.df(dg) ? _h("div", {className:`k`}, [_h(CN, {dh:dg})]) : null),_h("span", {className:`i`}, [di]),(CM.df(dj) ? _h("div", {className:`k`}, [_h(CN, {dh:dj})]) : null)])}render(){return _h("div", {className:`g`,style:_style([this.$g()]),ref:(element) => { this._base = element }}, [this.bv,_h(CO, {eu:this.et}, _array((this.dc < this.bq ? _h("div", {"onClick":(event => (this.cy)(_normalizeEvent(event)))}, [_h(CN, {dk:new CF(2),dl:true,dh:this.dm})]) : (()=>{const _0 = [];const _1 = this.bw;let _i = 0;for(let dn of _1){_0.push((()=>{let dp = dn;if(dp instanceof CP){return _h("div", {className:`j`})} else if(dp instanceof CQ){const dq = dp._0;return dq} else if(dp instanceof CW){const ed = dp._0.iconBefore;const ee = dp._0.iconAfter;const ds = dp._0.label;const eg = dp._0.items;return (()=>{let dt = CR.dr(ds);let dw = CK.du(dt, false, this.dv);return _h(CS, {dy:(()=>{return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({dv:CK.dx(dt, false, this.dv)})), _resolve)
}))}),dz:new CT(),ea:true,eb:15,ec:dw,ef:_h("div", {"onClick":(event => ((()=>{return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({dv:CK.dx(dt, true, this.dv)})), _resolve)
}))}))(_normalizeEvent(event))),"tabIndex":`0`,className:`h`,style:_style([this.$h(false)])}, [this.de(ed, ee, ds)]),ei:_h(CU, {}, _array(_h(CV, {eh:eg})))})})()} else if(dp instanceof CX){const ej = dp._0.iconBefore;const ek = dp._0.iconAfter;const el = dp._0.label;const em = dp._0.action;return _h("div", {"onClick":(event => (em)(_normalizeEvent(event))),className:`h`,style:_style([this.$h(false)])}, [this.de(ej, ek, el)])} else if(dp instanceof CG){const en = dp._0.iconBefore;const eo = dp._0.iconAfter;const ep = dp._0.label;const er = dp._0.href;const eq = dp._0.target;return _h("a", {"target":eq,"href":er,className:`h`,style:_style([this.$h(AS.es(er))])}, [this.de(en, eo, ep)])}})());_i++};return _0})())))])}};;class CV extends _C{constructor(props){super(props);this._d({ew:[null,new CB()],eh:[null,[]]})}$l(){const _={[`--c-a`]:CL.cr(this.ew)};return _}render(){return _h("div", {className:`l`,style:_style([this.$l()])}, [(()=>{const _0 = [];const _1 = this.eh;let _i = 0;for(let ex of _1){_0.push(_h(CY, {ey:ex}));_i++};return _0})()])}};;class CC extends _C{constructor(props){super(props);this._d({fd:[null,false],fe:[null,null],ff:[null,null],bz:[null,null],ci:[null,null],bx:[null,null],fc:[null,true],ez:[null,`100vw`]})}$m(){const _={[`--d-a`]:this.ez,[`--d-b`]:this.fa};(this.fb ? Object.assign(_, {[`--d-c`]:`0.5em 1em 0`}) : (this.fc ? Object.assign(_, {[`--d-d`]:`clamp(20em, 100%, 100em)`,[`--d-e`]:`auto`,[`--d-f`]:`auto`}) : null));return _}$o(){const _={};(this.fd ? Object.assign(_, {[`--e-a`]:`start`}) : null);return _}get fa(){return ((..._) => CR.fg(` `, ..._))(AT.q(((..._) => AT.bg(((fh)=>{return (()=>{const [fi,fj] = fh;return (CM.df(fi) ? new AW(fj) : new AV())})()}), ..._))([[this.fe, `min-content`], [this.bx, `min-content`], [this.ff, `min-content`], [this.bz, `1fr`], [this.ci, `min-content`]])))}get fb(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this)}componentDidMount(){CZ._subscribe(this)}render(){return _h("div", {className:`m`,style:_style([this.$m()])}, [(CM.df(this.fe) ? _h("div", {}, [this.fe]) : null),(CM.df(this.bx) ? _h("div", {}, [this.bx]) : null),(CM.df(this.ff) ? _h("div", {className:`n`}, [this.ff]) : null),(CM.df(this.bz) ? _h("div", {className:`o`,style:_style([this.$o()])}, [this.bz]) : null),(CM.df(this.ci) ? _h("div", {}, [this.ci]) : null)])}};;class DA extends _C{constructor(props){super(props);this._d({gh:[null,new DC()],fp:[null,true],gn:[null,CM.gq()],go:[null,CM.gq()],fy:[null,0],fo:[null,false],fl:[null,0]},{ge:(()=>{return AY.gp(`div`)})});this.state = new Record({fm:0,fn:0})}$p(){const _={[`--f-a`]:this.fl,[`--f-b`]:this.fm + `px`,[`--f-c`]:this.fn + `px`};(this.fo ? Object.assign(_, {[`--f-d`]:`none`}) : null);return _}get gf(){return (this._panel ? new AW(this._panel) : new AV);}get fm(){return this.state.fm;}get fn(){return this.state.fn;}componentWillUnmount(){BE._unsubscribe(this)}componentDidUpdate(){if (this.fp) {
  ...
  BE._unsubscribe(this)
}}fr(fv,fx,fs){let ft = (()=>{let fw = fv;if(fw instanceof DB){return fx.bottom + this.fy} else if(fw instanceof CT){return fx.bottom + this.fy} else if(fw instanceof DC){return fx.bottom + this.fy} else if(fw instanceof DD){return fx.top - fs.height - this.fy} else if(fw instanceof DE){return fx.top - fs.height - this.fy} else if(fw instanceof DF){return fx.top - fs.height - this.fy} else if(fw instanceof DG){return fx.top + (fx.height / 2) - (fs.height / 2)} else if(fw instanceof DH){return fx.bottom - fs.height} else if(fw instanceof DI){return fx.top} else if(fw instanceof DJ){return fx.top + (fx.height / 2) - (fs.height / 2)} else if(fw instanceof DK){return fx.bottom - fs.height} else if(fw instanceof DL){return fx.top}})();let fu = (()=>{let fz = fv;if(fz instanceof DB){return fx.left + (fx.width / 2) - (fs.width / 2)} else if(fz instanceof CT){return fx.right - fs.width} else if(fz instanceof DC){return fx.left} else if(fz instanceof DD){return fx.left + (fx.width / 2) - (fs.width / 2)} else if(fz instanceof DE){return fx.right - fs.width} else if(fz instanceof DF){return fx.left} else if(fz instanceof DG){return fx.right + this.fy} else if(fz instanceof DH){return fx.right + this.fy} else if(fz instanceof DI){return fx.right + this.fy} else if(fz instanceof DJ){return fx.left - fs.width - this.fy} else if(fz instanceof DK){return fx.left - fs.width - this.fy} else if(fz instanceof DL){return fx.left - fs.width - this.fy}})();return _u(fs, {bottom:ft + fs.height,right:fu + fs.width,left:fu,top:ft,x:fu,y:ft})}fq(gm){let gc = AY.gb((this.base));let gg = AY.gb(((..._) => AU.gd(this.ge, ..._))(this.gf));let gi = this.fr(this.gh, gc, gg);let ga = (CZ.gj(gi) ? gi : (()=>{let gl = this.fr(DM.gk(this.gh), gc, gg);return (CZ.gj(gl) ? gl : gi)})());return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({fm:ga.left,fn:ga.top})), _resolve)
}))}render(){return [this.gn, _h(BH, {}, _array(_h("div", {className:`p`,style:_style([this.$p()]),ref:(element) => { this._panel = element }}, [this.go])))]}};;class DN extends _C{constructor(props){super(props);this._d({gr:[null,new CB()],gt:[null,false],gu:["children",[]],gs:[null,``]})}$q(){const _={[`--g-a`]:CL.cr(this.gr),[`--g-b`]:this.gs};(this.gt ? Object.assign(_, {[`--g-c`]:`grid`}) : null);return _}get gv(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this)}componentDidMount(){CZ._subscribe(this)}render(){return _h("div", {className:`q`,style:_style([this.$q()])}, [this.gu])}};;class CN extends _C{constructor(props){super(props);this._d({hc:[null,AZ.hd],dk:[null,new CB()],dl:[null,false],gy:[null,false],gw:[null,1],dh:[null,null],ha:[null,``]})}$r(){const _={[`--h-a`]:CL.cr(this.dk),[`--i-a`]:this.gw};(this.gx ? Object.assign(_, {[`--j-a`]:`var(--primary-color)`}) : null);(this.gy ? Object.assign(_, {[`--h-b`]:`not-allowed`,[`--h-c`]:`0.5`}) : null);(this.gx ? Object.assign(_, {[`--i-b`]:`auto`,[`--i-c`]:`pointer`}) : Object.assign(_, {[`--i-b`]:`none`,[`--i-c`]:`auto`}));(this.gy ? Object.assign(_, {[`--i-b`]:`none`}) : null);return _}get gx(){return (this.dl || CR.gz(this.ha)) && !this.gy}render(){return (()=>{return (CR.gz(this.ha) ? _h("a", {"href":this.ha,className:`r s`,style:_style([this.$r()])}, [this.dh]) : (this.gx ? _h("button", {"onClick":(event => (CZ.hb(this.gy, this.hc))(_normalizeEvent(event))),className:`r t`,style:_style([this.$r()])}, [this.dh]) : _h("div", {"onClick":(event => (CZ.hb(this.gy, this.hc))(_normalizeEvent(event))),className:`r`,style:_style([this.$r()])}, [this.dh])))})()}};;class CE extends _C{constructor(props){super(props);this._d({br:[null,new CF(1.25)],bt:[null,null],bu:[null,``],bs:[null,``]})}$u(){const _={[`--k-a`]:CL.cr(this.br)};return _}render(){return (()=>{let he = _h(React.Fragment, {}, [(CM.df(this.bt) ? _h(CN, {dh:this.bt}) : null),_h("div", {className:`v`}, [this.bu])]);return (CR.hf(this.bs) ? _h("div", {"href":this.bs,className:`u`,style:_style([this.$u()])}, [he]) : _h("a", {"href":this.bs,className:`u w`,style:_style([this.$u()])}, [he]))})()}};;class CY extends _C{constructor(props){super(props);this._d({hg:[null,new CB()],ey:[null,null]})}$x(){const _={[`--l-a`]:CL.cr(this.hg)};return _}$y(hh){const _={};(hh ? Object.assign(_, {[`--o-a`]:`var(--primary-color)`}) : null);return _}$aa(){const _={[`--m-a`]:CL.cr(this.hg)};return _}$ab(){const _={[`--n-a`]:CL.cr(this.hg)};return _}componentWillUnmount(){AX._unsubscribe(this)}componentDidUpdate(){if (true) {
  ...
  AX._unsubscribe(this)
}}hj(hk,hm,hl){return _h(React.Fragment, {}, [(CM.df(hk) ? _h(CN, {dh:hk}) : null),hl,(CM.df(hm) ? _h(CN, {dh:hm}) : null)])}render(){return (()=>{let hn = this.ey;if(hn instanceof CW){const ho = hn._0.iconBefore;const hp = hn._0.iconAfter;const hq = hn._0.label;const hr = hn._0.items;return _h("div", {className:`ab`,style:_style([this.$ab()])}, [_h("strong", {className:`z x`,style:_style([this.$x()])}, [this.hj(ho, hp, hq)]),_h(CV, {eh:hr})])} else if(hn instanceof CG){const hs = hn._0.iconBefore;const ht = hn._0.iconAfter;const hu = hn._0.label;const hw = hn._0.href;const hv = hn._0.target;return _h("a", {"target":hv,"href":hw,className:`x y`,style:_style([this.$x(), this.$y(AS.es(hw))])}, [this.hj(hs, ht, hu)])} else if(hn instanceof CX){const hx = hn._0.iconBefore;const hy = hn._0.iconAfter;const hz = hn._0.label;const ia = hn._0.action;return _h("div", {"onClick":(event => (ia)(_normalizeEvent(event))),className:`x y`,style:_style([this.$x(), this.$y(false)])}, [this.hj(hx, hy, hz)])} else if(hn instanceof CP){return _h("div", {className:`aa`,style:_style([this.$aa()])})} else if(hn instanceof CQ){const ib = hn._0;return ib}})()}};;class CU extends _C{constructor(props){super(props);this._d({id:[null,new CB()],ig:["children",[]],ic:[null,`auto`],ie:[null,null]})}$ac(){const _={[`--p-a`]:this.ic,[`--p-b`]:CL.cr(this.id)};return _}get ih(){return (this._base ? new AW(this._base) : new AV);}get ii(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this)}componentDidMount(){CZ._subscribe(this)}render(){return _h("div", {className:`ac`,style:_style([this.$ac()]),ref:(element) => { this._base = element }}, [(CM.df(this.ie) ? _h("div", {className:`ad`}, [this.ie]) : null),_h("div", {className:`ae`}, [this.ig])])}};;class $B extends _C{constructor(props){super(props);this.state = new Record({it:((lc)=>{return null}),iv:new AV(),ij:new CB(),ix:[],ik:false})}$af(){const _={[`--q-a`]:CL.cr(this.ij)};(this.ik ? Object.assign(_, {[`--q-b`]:`visibility 1ms, opacity 320ms`,[`--q-c`]:`visibilie`,[`--q-d`]:`1`}) : Object.assign(_, {[`--q-b`]:`visibility 320ms 1ms, opacity 320ms`,[`--q-c`]:`hidden`,[`--q-d`]:`0`}));return _}$ag(il){const _={};(il ? Object.assign(_, {[`--r-a`]:`var(--content-faded-color)`,[`--r-b`]:`var(--content-faded-text)`,[`--r-c`]:`bold`}) : Object.assign(_, {[`--r-d`]:`pointer`}));return _}$ah(im){const _={};(!im ? Object.assign(_, {[`--s-a`]:`var(--primary-color)`}) : null);return _}$aj(){const _={};(this.ik ? Object.assign(_, {[`--t-a`]:`translateY(0)`,[`--t-b`]:`1`}) : Object.assign(_, {[`--t-a`]:`translateY(100%)`,[`--t-b`]:`0`}));return _}$ak(){const _={};(this.io ? Object.assign(_, {[`--u-a`]:`block`}) : Object.assign(_, {[`--u-a`]:`inline-block`,[`--u-b`]:`300px`}));return _}get jg(){return (this._container ? new AW(this._container) : new AV);}get jk(){return (this._scrollContainer ? new AW(this._scrollContainer) : new AV);}get lb(){return (this._base ? new AW(this._base) : new AV);}get it(){return this.state.it;}get iv(){return this.state.iv;}get ij(){return this.state.ij;}get ix(){return this.state.ix;}get ik(){return this.state.ik;}get io(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this);AX._unsubscribe(this);BC._unsubscribe(this)}componentDidUpdate(){if (true) {
...
}}componentDidMount(){CZ._subscribe(this);if (true) {
  AX._subscribe(this, new L({changes:this.ip}))
} else {
  AX._unsubscribe(this)
};if (true) {
...
}));await DO.is(320, ``);await this.it(null);await AY.iu(this.iv);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({it:((iw)=>{return null}),iv:new AV(),ij:new CB(),ix:[]})), _resolve)
...
}));(async()=>{let _ = null;try{await DO.is(10, ``);await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({ik:true})), _resolve)
}));await DO.is(100, ``);await (()=>{let jh = this.jg;if(jh instanceof AW){const jj = jh._0;return AY.ji(jj)} else if(jh instanceof AV){return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
...
}))}})()}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in sequence expression:`);console.warn(_error)}};return _})();return jd})())}cz(jo){return this.iy(new CB(), jo)}ip(jp){return this.ir()}jq(js){return (AY.jr(this.jg, js.target) ? new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
})) : this.ir())}jt(ju,jv){return (async()=>{let _ = null;try{await ju(jv);_ = await this.ir()}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in sequence expression:`);console.warn(_error)}};return _})()}jw(jx,jy){return (CR.gz(jx) && !jy.ctrlKey ? (async()=>{let _ = null;try{await DO.is(10, ``);_ = await this.ir()}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in sequence expression:`);console.warn(_error)}};return _})() : new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
})))}jz(kc,ka,kb,ke,kg,kh,kf){return (()=>{let kd = _h(React.Fragment, {}, [(CM.df(ka) ? _h(CN, {dh:ka}) : null),kb,(CM.df(kc) ? _h(CN, {dh:kc}) : null)]);return (ke ? _h("div", {"onClick":(event => (kf)(_normalizeEvent(event))),className:`ag ah`,style:_style([this.$ag(ke), this.$ah(ke)])}, [kd]) : (CR.gz(kg) ? _h("a", {"onClick":(event => (kf)(_normalizeEvent(event))),"target":kh,"href":kg,className:`ag ah`,style:_style([this.$ag(ke), this.$ah(ke)])}, [kd]) : _h("button", {"onClick":(event => (kf)(_normalizeEvent(event))),className:`ap ag ah`,style:_style([this.$ag(ke), this.$ah(ke)])}, [_h("div", {className:`ag`,style:_style([this.$ag(ke)])}, [kd])])))})()}ki(kj){return (()=>{let kk = kj;if(kk instanceof CQ){const kl = kk._0;return _h("div", {className:`ao`}, [kl])} else if(kk instanceof CP){return _h("div", {className:`ai`})} else if(kk instanceof CX){const km = kk._0.iconAfter;const kn = kk._0.iconBefore;const ko = kk._0.label;const kp = kk._0.action;return this.jz(km, kn, ko, false, ``, ``, ((..._) => this.jt(kp, ..._)))} else if(kk instanceof CG){const kq = kk._0.iconAfter;const kr = kk._0.iconBefore;const ks = kk._0.label;const kt = kk._0.href;const ku = kk._0.target;return this.jz(kq, kr, ks, false, kt, ku, ((..._) => this.jw(kt, ..._)))} else if(kk instanceof CW){const kv = kk._0.iconAfter;const kw = kk._0.iconBefore;const kx = kk._0.label;const kz = kk._0.items;return _h(React.Fragment, {}, [this.jz(kv, kw, kx, true, ``, ``, AZ.hd),_h("div", {className:`al`}, [_h("div", {className:`am`}),_h("div", {className:`an`}, [(()=>{const _0 = [];const _1 = kz;let _i = 0;for(let ky of _1){_0.push(this.ki(ky));_i++};return _0})()])])])}})()}render(){return _h(DP, {}, _array(_h("div", {"onClick":(event => (this.jq)(_normalizeEvent(event))),className:`af`,style:_style([this.$af()]),ref:(element) => { this._base = element }}, [_h("div", {className:`aj`,style:_style([this.$aj()]),ref:(element) => { this._scrollContainer = element }}, [_h("div", {className:`ak`,style:_style([this.$ak()]),ref:(element) => { this._container = element }}, [(()=>{const _0 = [];const _1 = this.ix;let _i = 0;for(let la of _1){_0.push(this.ki(la));_i++};return _0})()])])])))}_persist(){B=this}};;let B;class DQ extends _C{constructor(props){super(props);this._d({lj:[null,AZ.t],lf:[null,240],lh:[null,true],lk:["children",[]],lg:[null,`0`],ld:[null,900],le:[null,false]})}$aq(){const _={[`--v-a`]:this.ld};(this.le ? Object.assign(_, {[`--v-b`]:`opacity ` + this.lf + `ms 0ms ease,
                  visibility 1ms 0ms ease`,[`--v-c`]:`auto`,[`--v-d`]:`visible`,[`--v-e`]:`1`}) : Object.assign(_, {[`--v-b`]:`visibility 1ms ` + this.lf + `ms ease,
                  opacity ` + this.lf + `ms 0ms ease`,[`--v-c`]:`none`,[`--v-d`]:`hidden`,[`--v-e`]:`0`}));return _}$ar(){const _={[`--w-a`]:`transform ` + this.lf + `ms ease`,[`--w-b`]:this.lg};(this.le ? Object.assign(_, {[`--w-c`]:`translateX(0)`}) : Object.assign(_, {[`--w-c`]:`translateX(3em)`}));return _}get li(){return (this._drawer ? new AW(this._drawer) : new AV);}componentWillUnmount(){BA._unsubscribe(this)}componentDidUpdate(){if (this.le && this.lh) {
  ...
  BA._unsubscribe(this)
}}render(){return _h(BH, {}, _array(_h(DP, {}, _array(_h("div", {className:`aq`,style:_style([this.$aq()])}, [_h("div", {className:`ar`,style:_style([this.$ar()]),ref:(element) => { this._drawer = element }}, [this.lk])])))))}};;class DR extends _C{constructor(props){super(props);this._d({ll:[null,new CB()],lo:[null,null]})}$as(){const _={[`--x-a`]:CL.cr(this.ll)};return _}$at(ln){const _={};(this.lm || ln ? Object.assign(_, {[`--y-a`]:`break-spaces`}) : null);return _}get lm(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this)}componentDidMount(){CZ._subscribe(this)}render(){return _h("div", {className:`as`,style:_style([this.$as()])}, [(()=>{let lp = this.lo;if(lp instanceof DT){const lr = lp._0;return DS.lq(lr)} else if(lp instanceof DU){const ls = lp._0;return ls} else if(lp instanceof BZ){const lt = lp._0;return lt} else if(lp instanceof DV){const lu = lp._0.code;const lv = lp._0.breakSpaces;return _h("code", {className:`at`,style:_style([this.$at(lv)])}, [lu])} else if(lp instanceof CA){const lx = lp._0.items;const lw = lp._0.breakOnMobile;return (this.lm && lw ? _h(DW, {}, _array(lx)) : _h(DX, {ly:`start`}, _array(lx)))}})()])}};;class DW extends _C{constructor(props){super(props);this._d({mf:[null,new CB()],mh:[null,new CF(0.5)],lz:["children",[]],mb:[null,`stretch`],md:[null,`stretch`]})}render(){return _h(CO, {ma:`vertical`,mc:this.mb,me:this.md,mg:this.mf,eu:this.mh}, _array(this.lz))}};;class CO extends _C{constructor(props){super(props);this._d({ma:[null,`horizontal`],mc:[null,`stretch`],me:[null,`center`],mg:[null,new CB()],eu:[null,new CF(0.5)],mk:["children",[]]})}$au(){const _={[`--z-a`]:CL.cr(this.mg),[`--z-b`]:this.mc,[`--z-c`]:this.me};(_compare(this.ma, `horizontal`) ? Object.assign(_, {[`--z-d`]:`row`}) : Object.assign(_, {[`--z-d`]:`column`}));return _}$av(){const _={[`--aa-a`]:CL.cr(this.eu),[`--aa-b`]:CL.cr(this.eu)};return _}render(){return _h("div", {className:`au`,style:_style([this.$au()])}, [((..._) => AT.mi(_h("div", {className:`av`,style:_style([this.$av()])}), ..._))(CM.mj(this.mk))])}};;class BY extends _C{constructor(props){super(props);this._d({bn:[null,[]],bo:[null,new CB()],bp:[null,[]]});this.state = new Record({mq:DY.ne()})}$aw(){const _={[`--ab-a`]:CL.cr(this.bo)};return _}$ax(ml){const _={};(ml ? Object.assign(_, {[`--ac-a`]:`0.1875em solid var(--content-border)`}) : null);(ml ? Object.assign(_, {[`--ad-a`]:`0.0625em solid var(--content-border)`}) : null);return _}$ay(mm){const _={};(mm ? Object.assign(_, {[`--ae-a`]:`rotate(90deg)`}) : null);return _}get mq(){return this.state.mq;}mn(mp){return (()=>{return (DY.mo(mp, this.mq) ? new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({mq:DY.mr(mp, this.mq)})), _resolve)
})) : new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({mq:DY.ms(mp, this.mq)})), _resolve)
})))})}render(){return _h("div", {className:`aw`,style:_style([this.$aw()])}, [AT.mt(((mu, mx)=>{return (()=>{const [mv,mw] = mu;let my = DY.mo(mx, this.mq);return _h(React.Fragment, {}, [_h("div", {className:`ax`,style:_style([this.$ax(my)])}, [_h("div", {"onClick":(event => (this.mn(mx))(_normalizeEvent(event))),className:`ay`,style:_style([this.$ay(my)])}, [_h(CN, {dh:CI.mz}),_h("div", {className:`az`}, [mv])]),(my ? _h("div", {}, [(()=>{const _0 = [];const _1 = mw;let _i = 0;for(let nc of _1){_0.push((()=>{let nd = ((..._) => AU.gd(``, ..._))(((..._) => AT.na(AT.nb(nc, mw), ..._))(this.bp));return _h("div", {className:`bb`}, [_h("div", {className:`ba`}, [nd]),_h("div", {}, [_h(DR, {lo:nc})])])})());_i++};return _0})()]) : null)])])})()}), this.bn)])}};;class DX extends _C{constructor(props){super(props);this._d({nh:[null,new CB()],ni:[null,new CF(0.5)],nf:["children",[]],ly:[null,`stretch`],ng:[null,`stretch`]})}render(){return _h(CO, {ma:`horizontal`,mc:this.ly,me:this.ng,mg:this.nh,eu:this.ni}, _array(this.nf))}};;class CH extends _C{constructor(props){super(props);this._d({ch:[null,[]],nl:[null,`initial`],nj:[null,new CB()],ca:[null,null]})}$bc(){const _={[`--af-a`]:CL.cr(this.nj)};(this.nk ? Object.assign(_, {[`--af-b`]:`1fr`,[`--af-c`]:`1em`,[`--af-d`]:`1em 0`,[`--af-e`]:`1em`}) : null);return _}$be(){const _={[`--ag-a`]:this.nl};(this.nk ? Object.assign(_, {[`--ag-b`]:`0`}) : Object.assign(_, {[`--ag-b`]:`1em`}));return _}get nk(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this)}componentDidMount(){CZ._subscribe(this)}render(){return _h("div", {className:`bc`,style:_style([this.$bc()])}, [_h("div", {className:`bd`}, [this.ca]),_h("div", {className:`be`,style:_style([this.$be()])}, [(()=>{const _0 = [];const _1 = this.ch;let _i = 0;for(let nm of _1){_0.push(_h("div", {className:`bf`}, [_h("strong", {}, [nm[0]]),_h(CV, {eh:nm[1]})]));_i++};return _0})()])])}};;class $C extends _C{constructor(props){super(props);this.state = new Record({nr:((oe)=>{return null}),nu:((of)=>{return null}),ns:new AV(),nq:240,nw:null,oa:900,np:false})}get od(){return (this._base ? new AW(this._base) : new AV);}get nr(){return this.state.nr;}get nu(){return this.state.nu;}get ns(){return this.state.ns;}get nq(){return this.state.nq;}get nw(){return this.state.nw;}get oa(){return this.state.oa;}get np(){return this.state.np;}componentWillUnmount(){BC._unsubscribe(this)}componentDidUpdate(){if (true) {
...
}));await DO.is(this.nq, ``);await this.nr((null));await AY.iu(this.ns);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({nr:((nt)=>{return null}),nu:((nv)=>{return null}),ns:new AV(),nw:null})), _resolve)
...
}));await DO.is(this.nq, ``);await this.nu(null);await AY.iu(this.ns);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({nr:((nx)=>{return null}),nu:((ny)=>{return null}),ns:new AV(),nw:null})), _resolve)
}))}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in sequence expression:`);console.warn(_error)}};return _})()}render(){return _h(DZ, {nz:this.no,ob:this.oa,oc:this.np,ref:(instance) => { this._base = instance }}, _array(this.nw))}_persist(){C=this}};;let C;class DZ extends _C{constructor(props){super(props);this._d({nz:[null,AZ.t],og:[null,240],oh:[null,true],oj:["children",[]],ob:[null,900],oc:[null,false]})}$bg(){const _={[`--ah-a`]:this.ob};(this.oc ? Object.assign(_, {[`--ah-b`]:`opacity ` + this.og + `ms 0ms ease,
                  visibility 1ms 0ms ease`,[`--ah-c`]:`auto`,[`--ah-d`]:`visible`,[`--ah-e`]:`1`}) : Object.assign(_, {[`--ah-b`]:`visibility 1ms ` + this.og + `ms ease,
                  opacity ` + this.og + `ms 0ms ease`,[`--ah-c`]:`none`,[`--ah-d`]:`hidden`,[`--ah-e`]:`0`}));return _}$bh(){const _={[`--ai-a`]:`transform ` + this.og + `ms ease`};(this.oc ? Object.assign(_, {[`--ai-b`]:`translateY(0)`}) : Object.assign(_, {[`--ai-b`]:`translateY(-3em)`}));return _}get oi(){return (this._wrapper ? new AW(this._wrapper) : new AV);}componentWillUnmount(){BA._unsubscribe(this)}componentDidUpdate(){if (this.oc && this.oh) {
  ...
  BA._unsubscribe(this)
}}render(){return _h(DP, {}, _array(_h("div", {className:`bg`,style:_style([this.$bg()])}, [_h("div", {className:`bh`,style:_style([this.$bh()]),ref:(element) => { this._wrapper = element }}, [this.oj])])))}};;class CS extends _C{constructor(props){super(props);this._d({ou:[null,AZ.hd],dy:[null,AZ.t],dz:[null,new DC()],ea:[null,false],ok:[null,false],ef:[null,null],ei:[null,null],eb:[null,5],ot:[null,1],ec:[null,false]});this.state = new Record({ol:0})}$bi(){const _={};(this.ok ? Object.assign(_, {[`--aj-a`]:this.ol + `px`}) : null);(this.ec ? Object.assign(_, {[`--aj-b`]:`transform 150ms 0ms ease,
                  ...
                  opacity 150ms 0ms ease`,[`--aj-c`]:`translateY(20px)`,[`--aj-e`]:`hidden`,[`--aj-d`]:`0`}));return _}get oo(){return (this._panel ? new AW(this._panel) : new AV);}get op(){return (this._stickyPanel ? new AW(this._stickyPanel) : new AV);}get ol(){return this.state.ol;}get on(){return CZ.fk;}componentWillUnmount(){CZ._unsubscribe(this);BE._unsubscribe(this);BA._unsubscribe(this)}componentDidUpdate(){if (this.ec && this.ok) {
  BE._subscribe(this, new U({frames:this.om}))
} else {
  BE._unsubscribe(this)
};if (this.ea && this.ec && !this.on) {
  BA._subscribe(this, new M({elements:[this.oo],clicks:this.dy}))
} else {
  BA._unsubscribe(this)
}}componentDidMount(){CZ._subscribe(this);if (this.ec && this.ok) {
  BE._subscribe(this, new U({frames:this.om}))
} else {
  BE._unsubscribe(this)
};if (this.ea && this.ec && !this.on) {
...
}));await DO.is(this.oy, ``);await this.oz((null));await AY.iu(this.pa);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({oz:((pb)=>{return null}),pc:((pd)=>{return null}),pa:new AV(),pe:null})), _resolve)
...
}));await DO.is(this.oy, ``);await this.pc(null);await AY.iu(this.pa);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({oz:((pf)=>{return null}),pc:((pg)=>{return null}),pa:new AV(),pe:null})), _resolve)
}))}catch(_error){if(!(_error instanceof DoError)){console.warn(`Unhandled error in sequence expression:`);console.warn(_error)}};return _})()}render(){return _h(DQ, {lf:this.oy,lg:this.ph,lj:this.ow,ld:this.pi,le:this.ox,ref:(instance) => { this._base = instance }}, _array(this.pe))}_persist(){D=this}};;let D;class BX extends _C{constructor(props){super(props);this._d({pn:[null,new CB()],pm:[null,false],pp:["children",[]],bm:[null,null],po:[null,null]})}$bj(){const _={};(this.pm ? Object.assign(_, {[`--al-a`]:`grid`}) : null);return _}$bm(){const _={[`--ak-a`]:CL.cr(this.pn)};(CM.df(this.po) ? Object.assign(_, {[`--ak-b`]:`auto 1fr`}) : null);return _}render(){return (()=>{return _h("div", {className:`bm`,style:_style([this.$bm()])}, [(CM.df(this.po) ? _h("div", {className:`bl`}, [this.po]) : null),_h("div", {className:`bj`,style:_style([this.$bj()])}, [(CM.df(this.bm) ? _h("div", {className:`bk`}, [this.bm]) : null),_h(DN, {gt:this.pm}, _array(this.pp))])])})()}};;class DP extends _C{constructor(props){super(props);this._d({qc:["children",[]]})}get pr(){return (this._base ? new AW(this._base) : new AV);}pq(pt){return (()=>{let ps = this.pr;if(ps instanceof AW){const pw = ps._0;return (_compare(pt.keyCode, 9) ? (()=>{let pu = new AW(pt.target);let px = AY.pv(pw);let pz = AT.py(px);let qb = AT.qa(px);return (pt.shiftKey && _compare(pz, pu) ? (()=>{BB.ag(pt);return AY.iu(qb)})() : (!pt.shiftKey && _compare(qb, pu) ? (()=>{BB.ag(pt);return AY.iu(pz)})() : new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
}))))})() : new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
})))} else{return new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
}))}})()}render(){return _h("div", {"onKeyDown":(event => (this.pq)(_normalizeEvent(event))),ref:(element) => { this._base = element }}, [this.qc])}};;class CJ extends _C{constructor(props){super(props);this._d({cn:[null,null],cm:[null,0]});this.state = new Record({qe:false})}$bn(){const _={[`--am-a`]:this.qd + `px`};(this.qe ? Object.assign(_, {[`--am-b`]:`transform 320ms`,[`--am-c`]:`translateX(0)`,[`--am-d`]:`10px`}) : Object.assign(_, {[`--am-c`]:`translateX(150%)`,[`--am-d`]:`0`,[`--am-b`]:`margin-bottom 320ms 200ms,
                  height 320ms 200ms,
                  transform 320ms`}));return _}$bo(){const _={[`--an-a`]:`duration-notification linear both ` + this.cm + `ms`};return _}get qd(){return (this.qe ? ((..._) => AU.gd(0, ..._))(((..._) => AU.g(((_) => _.height), ..._))(((..._) => AU.g(AY.gb, ..._))(this.qh))) : 0)}get qh(){return (this._base ? new AW(this._base) : new AV);}get qe(){return this.state.qe;}componentDidMount(){return (async()=>{let _ = null;try{await DO.qg(``);await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({qe:true})), _resolve)
}));await DO.is(this.cm, ``);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({qe:false})), _resolve)
...
<circle style="opacity:1;mix-blend-mode:normal;fill:url(#linearGradient1673);fill-opacity:1;fill-rule:nonzero;stroke:url(#linearGradient1661);stroke-width:60;stroke-dasharray:none;paint-order:markers fill stroke" id="path926" cx="1623.7734" cy="1627.6438" r="1599.5652"/>` }}));const $r=_m(() => _h('svg', { width: '12', height: '16', viewBox: '0 0 12 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M11.41 9H.59C0 9 0 8.59 0 8c0-.59 0-1 .59-1H11.4c.59 0 .59.41.59 1 0 .59 0 1-.59 1h.01zm0-4H.59C0 5 0 4.59 0 4c0-.59 0-1 .59-1H11.4c.59 0 .59.41.59 1 0 .59 0 1-.59 1h.01zM.59 11H11.4c.59 0 .59.41.59 1 0 .59 0 1-.59 1H.59C0 13 0 12.59 0 12c0-.59 0-1 .59-1z"/>` }}));const $s=_m(() => _h('svg', { width: '16', height: '16', viewBox: '0 0 16 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M16 9l-3-3V2h-2v2L8 1 0 9h2l1 5c0 .55.45 1 1 1h8c.55 0 1-.45 1-1l1-5h2zm-4 5H9v-4H7v4H4L2.81 7.69 8 2.5l5.19 5.19L12 14z"/>` }}));const $t=_m(() => _h('svg', { width: '14', height: '16', viewBox: '0 0 14 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M9 4V3c0-.55-.45-1-1-1H6c-.55 0-1 .45-1 1v1H1c-.55 0-1 .45-1 1v8c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1H9zM6 3h2v1H6V3zm7 6H8v1H6V9H1V5h1v3h10V5h1v4z"/>` }}));const $u=_m(() => _h('svg', { width: '16', height: '16', viewBox: '0 0 16 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/>` }}));const $v=_m(() => _h('svg', { width: '16', height: '16', viewBox: '0 0 16 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M11 10h3V9h-3V8l3.17-1.03-.34-.94L11 7V6c0-.55-.45-1-1-1V4c0-.48-.36-.88-.83-.97L10.2 2H12V1H9.8l-2 2h-.59L5.2 1H3v1h1.8l1.03 1.03C5.36 3.12 5 3.51 5 4v1c-.55 0-1 .45-1 1v1l-2.83-.97-.34.94L4 8v1H1v1h3v1L.83 12.03l.34.94L4 12v1c0 .55.45 1 1 1h1l1-1V6h1v7l1 1h1c.55 0 1-.45 1-1v-1l2.83.97.34-.94L11 11v-1zM9 5H6V4h3v1z"/>` }}));const $w=_m(() => _h('svg', { width: '16', height: '16', viewBox: '0 0 16 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M15 2H1c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5.34c-.25.61-.86 1.39-2.34 2h8c-1.48-.61-2.09-1.39-2.34-2H15c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 9H1V3h14v8z"/>` }}));const $x=_m(() => _h('svg', { width: '12', height: '16', viewBox: '0 0 12 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M12 14.002a.998.998 0 01-.998.998H1.001A1 1 0 010 13.999V13c0-2.633 4-4 4-4s.229-.409 0-1c-.841-.62-.944-1.59-1-4 .173-2.413 1.867-3 3-3s2.827.586 3 3c-.056 2.41-.159 3.38-1 4-.229.59 0 1 0 1s4 1.367 4 4v1.002z"/>` }}));const $y=_m(() => _h('svg', { width: '8', height: '16', viewBox: '0 0 8 16', dangerouslySetInnerHTML: { __html: `<path fill-rule="evenodd" d="M7.5 8l-5 5L1 11.5 4.75 8 1 4.5 2.5 3l5 5z"/>` }}));const EZ=new(class extends _S{constructor(){super();this.state={wv:new EY()}}get wv(){return this.state.wv;}wu(){return (async()=>{let _ = null;try{await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({wv:new EV()})), _resolve)
}));let wx = await (async()=>{try{return await ED.sb(ED.rt(`http://localhost:3001/api/` + `papers/list`))}catch(_error){let ww = _error;_=new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({wv:new EW(`Something went wrong with the request.`)})), _resolve)
}));throw new DoError()}})();let _2 = ((..._) => AU.rk(``, ..._))(EP.us(wx.body));if(_2 instanceof Err){let _error = _2._0;let wy = _error;_=new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({wv:new EW(`Invalid JSON data.`)})), _resolve)
}));throw new DoError()};let wz = _2._0;await ER.vi(wz);let _4 = ((_)=>AJ.decode(_))(wz);if(_4 instanceof Err){let _error = _4._0;let xa = _error;_=new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({wv:new EW(`The papers data is not what is expected.`)})), _resolve)
}));throw new DoError()};let xb = _4._0;await ER.vi(xb);_ = await new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({wv:new EX(xb)})), _resolve)
      ...
      return true;
    })())}yc(yd){return (CZ.ya(yd) ? new Promise(((_resolve)=>{this.setState(_u(this.state, new Record({})), _resolve)
})) : (yd.scrollIntoView({
        behavior: "smooth",
        inline: "center",
        block: "center",
