    ...
    <div>
      ...
      <Ui.Box title=<{ "プログラミング" }>>
        <p>
          ...
          <br/>
          "　趣味として開発した標本データベース管理Webサービス"

          <a::a href="https://www.webspecimanager.net/">
            "WebSpecimanager"
          </a>

          "を無償で提供しております。標本のデータベース管理を始めてみたい方は是非ご利用をご検討ください。"
          <br/>
          "　最近は開発のみならず競技プログラミングも楽しむようになりました。正直なところ私は非常に弱く平均的なプレイヤーより成長がかなり遅いのですが、その高いゲーム性に魅せられて毎週のようにコンテストに参加して楽しんでいます。現時点ではAtCoderのアルゴは茶色、ヒューリスティックは緑です。ユーザーIDは"
