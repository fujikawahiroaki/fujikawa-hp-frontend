          ...
          rows=[
            {
              "小松拓実・梅田晴行・藤川浩明・棚原怜央・波多野幸希・青井光太郎, 2025. 奄美群島枝手久島におけるコガネムシ上科の分布記録. Fauna Ryukyuana, (77): 47–61.", [
                Ui.Cell::Html(
                  <div>"奄美群島に属する無人島の枝手久島からコガネムシ上科甲虫を3科9亜科32種記録しました。"</div>),
                Ui.Cell::HtmlItems(
                  items =
                    [
                      <div>
                        <a
                          href="https://u-ryukyu.repo.nii.ac.jp/search?page=1&size=20&sort=controlnumber&search_type=2&q=1760925367914"
                          target="_blank">
